...
class _ListeState extends State<Olaylar> {
  Future<List<HaberModel>> _gonderiGetir() async {
    final jobsListAPIUrl =
        'https://antepsavunmasi.com/harpgunlugu/json-app/olaylar.json';
                  ...
                  itemBuilder: (context, index) {
                    return Card(
                      child: ListTile(
                          ...
                          subtitle: Text(snapshot.data[index].tarih.toString()),
